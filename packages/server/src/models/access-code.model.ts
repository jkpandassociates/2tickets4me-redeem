...
export interface AccessCodeInstance
  extends Sequelize.Instance<AccessCodeAttributes> {}

export function defineModel(
  sequelize: Sequelize.Sequelize,
  dataTypes: Sequelize.DataTypes
) {
  return sequelize.define<AccessCodeInstance, AccessCodeAttributes>(
    'AccessCode',
    {
      Id: {
...
export const validations = Joi.object({
  ...
  SurveyUrl: Joi.string()
    .optional()
    .allow(null),
  SurveyPassword: Joi.string()
    .optional()
    .allow(null),
  EmailAddressesToNotify: Joi.string()
    .optional()
    .allow(null)
});
...
function beforeValidate(
  ...
  accessCode: AccessCodeInstance,
  _: Sequelize.DefineOptions<AccessCodeInstance>,
