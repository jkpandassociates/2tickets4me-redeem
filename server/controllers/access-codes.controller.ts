...
const accessCodeErrors = {
    ...
    [ErrorCode.CODE_LIMIT_EXCEEDED]: 'The maximum redemptions for this code has been exceeded.',
...
const getErrorDetails = (errorCode: ErrorCode): { errorCode: string; errorMessage: string; } => {
...
class AccessCodesController implements Controller {
                    ...
                    recipients: [
                        {
                            ...
                            substitution_data: {
                                ...
                                ErrorMessage: [errorMessage, 'Use of this code has been denied.'].join(' ')
                            }
                        }
                    ],
                    content: {
    ...
    private async validateAccessCode(code: string): Promise<{ valid: boolean; accessCode?: AccessCodeAttributes; client?: ClientAttributes; errorCode?: string; errorMessage?: string; }> {
